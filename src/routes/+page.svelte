...
<header id="header" class="sticky top-0 z-100 w-full px-1 py-1">
	<div class="mx-auto flex max-w-full items-center justify-between">
		<div class="bg-bar h-5 w-18 overflow-hidden transition-colors duration-300">
			<div
				class="bar h-full origin-left transition-colors transition-transform duration-300 ease-linear"
...
<section id="wrapper">
	<section class="flex h-screen max-w-full justify-center px-4">
		...
		<!-- <p
			class="pointer-events-none absolute left-0 bottom-0 z-90 px-4 py-5 text-right text-base leading-none uppercase"
		>
